...
const ListaProdutosServico: React.FC<Props> = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="produto">
                ...
                <ul className="collection">
                    <li className="collection-item avatar">
                        <a href="#" className="title" onClick={handleShowInfoModal}>Racao para Caes</a>
                    ...
                    <li className="collection-item avatar">
                        <a href="#" className="title" onClick={handleShowInfoModal}>Racao para Gatos</a>
                        <div className="secondary-content">
                            <button onClick={handleShowEditModal} type="button" className="btn-floating btn-small waves-effect waves-light blue">
                                <AiFillEdit style={{ fontSize: 20 }} />
                            </button>
            ...
            <div className="servico">
                ...
                <ul className="collection">
                    <li className="collection-item avatar">
                        <a href="#" className="title" onClick={handleShowInfoModal}>Banho</a>
                        <div className="secondary-content">
                            <button onClick={handleShowEditModal} type="button" className="btn-floating btn-small waves-effect waves-light blue">
                                <AiFillEdit style={{ fontSize: 20 }} />
                            </button>
                    ...
                    <li className="collection-item avatar">
                        <a href="#" className="title" onClick={handleShowInfoModal}>Tosa</a>
                        <div className="secondary-content">
                            <button onClick={handleShowEditModal} type="button" className="btn-floating btn-small waves-effect waves-light blue">
                                <AiFillEdit style={{ fontSize: 20 }} />
                            </button>
...
export default ListaProdutosServico;