...
export default class ListaDePets extends Component<Props, State> {
                ...
                <div className="conteudo">
                    ...
                    <ul className="collection">
                        <li className="collection-item avatar">
                            <a href="#" className="title" onClick={this.handleShowInfoModal}>Rex</a>
                        ...
                        <li className="collection-item avatar">
                            <a href="#" className="title" onClick={this.handleShowInfoModal}>Bella</a>
                            <div className="secondary-content">
                                <button onClick={this.handleShowEditModal} type="button" className="btn-floating btn-small waves-effect waves-light blue">
                                    <AiFillEdit style={{ fontSize: 20 }} />
                                </button>
